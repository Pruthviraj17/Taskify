...
class AddTaskItem extends ConsumerStatefulWidget {
  const AddTaskItem({
    super.key,
    required this.ref,
    this.taskItem,
  ...
  @override
  ConsumerState<AddTaskItem> createState() => _AddTodoItemState();
}

class _AddTodoItemState extends ConsumerState<AddTaskItem> {
  ...
  void _addItemToList() {
    if (_formKey.currentState!.validate()) {
      ...
      widget.ref.read(pendingTaskProvider.notifier).addNewItem(newTask);
  ...
  Future<void> _saveEdit() async {
    if (_formKey.currentState!.validate()) {
      ...
      await FirestoreService().updateTaskDetails(taskItem);
